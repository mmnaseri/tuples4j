...
public class CachingReflectorTest {
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp = "Proxies can only be created using interface types.")
  public void testCreatingProxyUsingNonInterface() {
    CachingReflector reflector =
        new CachingReflector(Tuple.of(), DefaultTypeConverter.getInstance());
