...
public interface LabeledTuple<Z> extends Tuple<Z> {
  ...
  /**
   * Returns the labels for the elements. This is guaranteed to have the same size as {@link
   * #size()}.
   */
  List<String> labels();
  ...
  /**
   * Extends the tuple by adding the value and labelling it automatically. You can later relabel
   * this by {@link #relabel(int, String)} or instead, you can guarantee a custom label by using
   * {@link #extend(Object, String)}.
   */
  @Override
  ...
  static LabeledTuple<Object> of(
      String label1, Object value1, String label2, Object value2, String label3, Object value3) {
