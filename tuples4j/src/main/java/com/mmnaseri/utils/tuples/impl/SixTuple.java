...
public class SixTuple<
    ...
    implements HasFirst<Z, A, SixTuple<Z, A, B, C, D, E, F>>,
   ...
   */
  @Override
  public SixTuple<Z, Z, Z, Z, Z, Z, Z> change(
      int index, Function<SixTuple<Z, A, B, C, D, E, F>, ? extends Z> function) {
    checkIndex(index, size());
    return new SixTuple<>(
   ...
   */
  @Override
  public <X extends Z> SevenTuple<Z, A, B, C, D, E, F, X> extend(
  ...
  public static <Z, A extends Z, B extends Z, C extends Z, D extends Z, E extends Z, F extends Z>
      SixTuple<Z, A, B, C, D, E, F> of(A first, B second, C third, D fourth, E fifth, F sixth) {
