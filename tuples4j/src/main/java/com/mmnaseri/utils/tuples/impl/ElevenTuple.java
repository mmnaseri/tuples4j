...
public class ElevenTuple<Z, A extends Z, B extends Z, C extends Z, D extends Z, E extends Z, F extends Z, G extends Z, H extends Z, I extends Z, J extends Z, K extends Z> extends AbstractFixedTuple<Z, ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>>
	...
	public static <Z, A extends Z, B extends Z, C extends Z, D extends Z, E extends Z, F extends Z, G extends Z, H extends Z, I extends Z, J extends Z, K extends Z, X extends Z> Function<ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>, TwelveTuple<Z, A, B, C, D, E, F, G, H, I, J, K, X>> extendWith(Function<ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>, X> function) {
