...
public class ElevenTuple<
    ...
    implements HasFirst<Z, A, ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>>,
   ...
   */
  @Override
  public ElevenTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
  ...
  @Override
  public ElevenTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
      int index, Function<ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>, ? extends Z> function) {
    checkIndex(index, size());
    return new ElevenTuple<>(
   ...
   */
  @Override
  public <X extends Z> TwelveTuple<Z, A, B, C, D, E, F, G, H, I, J, K, X> extend(
      Supplier<X> supplier) {
    return new TwelveTuple<>(
        first(),
        second(),
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, X, B, C, D, E, F, G, H, I, J, K> first(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, X, C, D, E, F, G, H, I, J, K> second(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        supplier.get(),
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, X, D, E, F, G, H, I, J, K> third(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, X, E, F, G, H, I, J, K> fourth(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        second(),
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, X, F, G, H, I, J, K> fifth(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, X, G, H, I, J, K> sixth(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, X, H, I, J, K> seventh(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        second(),
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, X, I, J, K> eighth(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        second(),
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, X, J, K> ninth(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, I, X, K> tenth(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, X> eleventh(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        second(),
  ...
  public static <
      ...
      Function<
              ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>,
              TwelveTuple<Z, A, B, C, D, E, F, G, H, I, J, K, X>>
          extendWith(Function<ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K>, X> function) {
  ...
  public static <
          ...
          J extends Z,
          K extends Z>
      ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, K> of(
          A first,
          B second,
          C third,
          D fourth,
