...
public interface FixedTuple<Z, T extends FixedTuple<Z, T>> extends Tuple<Z> {
    ...
    /**
     * Extends the current tuple by applying the provided function to it and appending the resulting value to the end of this tuple.
     */
    <X extends Z> Tuple<Z> extend(Function<T, X> function);

    /**
     * Returns a new tuple that changes the value of the element at the given index by applying the provided function to the current tuple.
     */
