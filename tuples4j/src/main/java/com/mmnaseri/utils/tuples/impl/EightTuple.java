...
public class EightTuple<
    ...
    implements HasFirst<Z, A, EightTuple<Z, A, B, C, D, E, F, G, H>>,
   ...
   */
  @Override
  public EightTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
      int index, Function<EightTuple<Z, A, B, C, D, E, F, G, H>, ? extends Z> function) {
    checkIndex(index, size());
    return new EightTuple<>(
   ...
   */
  @Override
  public <X extends Z> NineTuple<Z, A, B, C, D, E, F, G, H, X> extend(
      Function<EightTuple<Z, A, B, C, D, E, F, G, H>, X> function) {
    return new NineTuple<>(
        first(),
        second(),
        third(),
  ...
  public static <
          ...
          X extends Z>
      Function<EightTuple<Z, A, B, C, D, E, F, G, H>, NineTuple<Z, A, B, C, D, E, F, G, H, X>>
          extendWith(Function<EightTuple<Z, A, B, C, D, E, F, G, H>, X> function) {
  ...
  public static <
          ...
          G extends Z,
          H extends Z>
      EightTuple<Z, A, B, C, D, E, F, G, H> of(
