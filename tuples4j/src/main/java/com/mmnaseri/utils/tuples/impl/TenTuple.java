...
public class TenTuple<Z, A extends Z, B extends Z, C extends Z, D extends Z, E extends Z,
                             F extends Z, G extends Z
                             , H extends Z, I extends Z, J extends Z>
        extends AbstractFixedTuple<Z, TenTuple<Z, A, B, C, D, E, F, G, H, I, J>>
        implements
    ...
    public TenTuple(A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth,
            I ninth, J tenth) {
    ...
    public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, X> extend(final X value) {
        return new ElevenTuple<>(first(), second(), third(), fourth(), fifth(), sixth(), seventh(),
                                 eighth(), ninth(),
                                 tenth(), value);
    }
    ...
    public NineTuple<Z, A, C, D, E, F, G, H, I, J> dropSecond() {
        return new NineTuple<>(first(), third(), fourth(), fifth(), sixth(), seventh(), eighth(),
                               ninth(), tenth());
    }

    @Override
    public NineTuple<Z, A, B, D, E, F, G, H, I, J> dropThird() {
        return new NineTuple<>(first(), second(), fourth(), fifth(), sixth(), seventh(), eighth(),
                               ninth(), tenth());
    }

    @Override
    public NineTuple<Z, A, B, C, E, F, G, H, I, J> dropFourth() {
        return new NineTuple<>(first(), second(), third(), fifth(), sixth(), seventh(), eighth(),
                               ninth(), tenth());
    }

    @Override
    public NineTuple<Z, A, B, C, D, F, G, H, I, J> dropFifth() {
        return new NineTuple<>(first(), second(), third(), fourth(), sixth(), seventh(), eighth(),
                               ninth(), tenth());
    }

    @Override
    public NineTuple<Z, A, B, C, D, E, G, H, I, J> dropSixth() {
        return new NineTuple<>(first(), second(), third(), fourth(), fifth(), seventh(), eighth(),
                               ninth(), tenth());
    }

    @Override
    public NineTuple<Z, A, B, C, D, E, F, H, I, J> dropSeventh() {
        return new NineTuple<>(first(), second(), third(), fourth(), fifth(), sixth(), eighth(),
                               ninth(), tenth());
    }
