...
public class TenTuple<
    ...
    implements HasFirst<Z, A, TenTuple<Z, A, B, C, D, E, F, G, H, I, J>>,
   ...
   */
  @Override
  public TenTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
  ...
  @Override
  public TenTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
      int index, Function<TenTuple<Z, A, B, C, D, E, F, G, H, I, J>, ? extends Z> function) {
    checkIndex(index, size());
    return new TenTuple<>(
   ...
   */
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, X> extend(
      Supplier<X> supplier) {
    return new ElevenTuple<>(
        first(),
        second(),
  ...
  @Override
  public <X extends Z> ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, X> extend(
      Function<TenTuple<Z, A, B, C, D, E, F, G, H, I, J>, X> function) {
    return new ElevenTuple<>(
        first(),
        second(),
        third(),
  ...
  public static <
      ...
      Function<
              TenTuple<Z, A, B, C, D, E, F, G, H, I, J>,
              ElevenTuple<Z, A, B, C, D, E, F, G, H, I, J, X>>
          extendWith(Function<TenTuple<Z, A, B, C, D, E, F, G, H, I, J>, X> function) {
  ...
  public static <
          ...
          I extends Z,
          J extends Z>
      TenTuple<Z, A, B, C, D, E, F, G, H, I, J> of(
          A first,
          B second,
          C third,
          D fourth,
