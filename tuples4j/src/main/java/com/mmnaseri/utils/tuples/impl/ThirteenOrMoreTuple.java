...
/**
 * Class for dealing with a {@link com.mmnaseri.utils.tuples.FixedTuple} with thirteen or more
 * elements.
 *
 * @author Milad Naseri (m.m.naseri@gmail.com)
 */
public class ThirteenOrMoreTuple<
        Z,
        A extends Z,
        B extends Z,
        C extends Z,
    ...
    implements HasFirst<Z, A, ThirteenOrMoreTuple<Z, A, B, C, D, E, F, G, H, I, J, K, L>>,
   ...
   */
  @Override
  public ThirteenOrMoreTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
  ...
  public ThirteenOrMoreTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
      int index,
      Function<ThirteenOrMoreTuple<Z, A, B, C, D, E, F, G, H, I, J, K, L>, ? extends Z> function) {
    checkIndex(index, size());
  ...
  public static <
          ...
          K extends Z,
          L extends Z>
      ThirteenOrMoreTuple<Z, A, B, C, D, E, F, G, H, I, J, K, L> of(
          A first,
          B second,
          C third,
          D fourth,
