...
public class NineTuple<
    ...
    implements HasFirst<Z, A, NineTuple<Z, A, B, C, D, E, F, G, H, I>>,
   ...
   */
  @Override
  public NineTuple<Z, Z, Z, Z, Z, Z, Z, Z, Z, Z> change(
      int index, Function<NineTuple<Z, A, B, C, D, E, F, G, H, I>, ? extends Z> function) {
    checkIndex(index, size());
    return new NineTuple<>(
   ...
   */
  @Override
  public <X extends Z> TenTuple<Z, A, B, C, D, E, F, G, H, I, X> extend(
      Function<NineTuple<Z, A, B, C, D, E, F, G, H, I>, X> function) {
    return new TenTuple<>(
        first(),
        second(),
        third(),
  ...
  public static <
          ...
          X extends Z>
      Function<NineTuple<Z, A, B, C, D, E, F, G, H, I>, TenTuple<Z, A, B, C, D, E, F, G, H, I, X>>
          extendWith(Function<NineTuple<Z, A, B, C, D, E, F, G, H, I>, X> function) {
  ...
  public static <
          ...
          H extends Z,
          I extends Z>
      NineTuple<Z, A, B, C, D, E, F, G, H, I> of(
          A first, B second, C third, D fourth, E fifth, F sixth, G seventh, H eighth, I ninth) {
