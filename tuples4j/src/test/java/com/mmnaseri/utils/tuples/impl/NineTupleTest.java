...
public class NineTupleTest {
  ...
  public void creatingTuple() {
    NineTuple<
            Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        tuple = Tuple.nine(0, 1, 2, 3, 4, 5, 6, 7, 8);
  ...
  public void testToArray() {
    Tuple<Object> tuple = Tuple.of(0, 1, 2, 3, 4, 5, 6, 7, 8);
  ...
  public void testResizeAsEmpty() {
    Tuple<Object> tuple = Tuple.nine(0, 1, 2, 3, 4, 5, 6, 7, 8);
  ...
  public void checkingPredicateByIndex() {
    NineTuple<
            ...
            Integer,
            Integer>
        tuple = NineTuple.of(0, 1, 2, 3, 4, 5, 6, 7, 8);
    for (int i = 0; i < 9; i++) {
  ...
  public void extendingByValue() {
    ...
    TenTuple<
            ...
            Integer,
            Integer>
        secondTuple = NineTuple.extendWith(-1).apply(tuple);
    assertThat(secondTuple, is(notNullValue()));
  ...
  public void labelingTuple() {
    ...
    LabeledTuple<Integer> other =
        tuple.withLabels("e0", "e1", "e2", "e3", "e4", "e5", "e6", "e7", "e8");
    assertThat(other, is(notNullValue()));
    assertThat(other.size(), is(9));
  ...
  public void equality() {
    ...
    NineTuple<
            Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        secondTuple = Tuple.nine(0, 1, 2, 3, 4, 5, 6, 7, 8);
