...
public class SixTupleTest {
  ...
  public void creatingTuple() {
    SixTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        Tuple.six(0, 1, 2, 3, 4, 5);
  ...
  public void testToArray() {
    Tuple<Object> tuple = Tuple.of(0, 1, 2, 3, 4, 5);
  ...
  public void testResizeAsEmpty() {
    Tuple<Object> tuple = Tuple.six(0, 1, 2, 3, 4, 5);
  ...
  public void changingFirstElementByAccessor() {
    ...
    // Changing by value.
    SixTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple =
        tuple.first(-1);
    ...
    SixTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple =
        tuple.first(() -> -1);
    ...
    SixTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple =
  ...
  public void checkingPredicateByIndex() {
    SixTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        SixTuple.of(0, 1, 2, 3, 4, 5);
    for (int i = 0; i < 6; i++) {
  ...
  public void extendingByValue() {
    SixTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        SixTuple.of(0, 1, 2, 3, 4, 5);
    SevenTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple =
        SixTuple.extendWith(-1).apply(tuple);
    assertThat(secondTuple, is(notNullValue()));
  ...
  public void extendingByFunction() {
    ...
    SevenTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple =
        SixTuple.extendWith(
                (SixTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer> t) -> -1)
            .apply(tuple);
    assertThat(secondTuple, is(notNullValue()));
    assertThat(secondTuple.size(), is(7));
    assertThat(secondTuple.first(), is(tuple.first()));
