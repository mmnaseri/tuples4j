...
public class FiveTupleTest {
    ...
    public void creatingTuple() {
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.five(0, 1, 2, 3, 4);
    ...
    public void changingFirstElementByAccessor() {
        ...
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.first(() -> -1);
        ...
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.first(previous -> -1);
    ...
    public void changingSecondElementByAccessor() {
        ...
        // Changing by supplier.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.second(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        ...
        // Changing by function.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.second(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
    ...
    public void changingThirdElementByAccessor() {
        ...
        // Changing by supplier.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.third(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.third(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingFourthElementByAccessor() {
        ...
        // Changing by supplier.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.fourth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.fourth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingFifthElementByAccessor() {
        ...
        // Changing by supplier.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.fifth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.fifth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void checkingPredicateByIndex() {
        FiveTuple<Integer, Integer, Integer, Integer, Integer, Integer> tuple = FiveTuple.of(0, 1, 2, 3, 4);
        for (int i = 0; i < 5; i++) {
    ...
    public void extendingByValue() {
        FiveTuple<Integer, Integer, Integer, Integer, Integer, Integer> tuple = FiveTuple.of(0, 1, 2, 3, 4);
        SixTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = FiveTuple.extendWith(-1).apply(tuple);
        assertThat(secondTuple, is(notNullValue()));
    ...
    public void extendingByFunction() {
        FiveTuple<Integer, Integer, Integer, Integer, Integer, Integer> tuple = FiveTuple.of(0, 1, 2, 3, 4);
        SixTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = FiveTuple.extendWith((FiveTuple<Integer, Integer, Integer, Integer, Integer, Integer> t) -> -1).apply(tuple);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(6));
        assertThat(secondTuple.first(), is(tuple.first()));
        assertThat(secondTuple.second(), is(tuple.second()));
    ...
    public void equality() {
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.five(0, 1, 2, 3, 4);
        FiveTuple<Object, Integer, Integer, Integer, Integer, Integer> secondTuple = Tuple.five(0, 1, 2, 3, 4);
