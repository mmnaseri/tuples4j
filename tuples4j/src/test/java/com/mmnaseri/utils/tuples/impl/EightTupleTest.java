...
/**
 * Tests for {@link EightTuple}.
 *
 * @author Milad Naseri (m.m.naseri@gmail.com)
 */
public class EightTupleTest {

    @Test
    public void creatingTuple() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
    ...
    public void changingFirstElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.first(-1);
        ...
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.first(() -> -1);
        ...
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.first(previous -> -1);
    ...
    public void changingSecondElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.second(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.second(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.second(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
    ...
    public void changingThirdElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.third(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.third(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.third(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingFourthElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.fourth(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.fourth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.fourth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingFifthElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.fifth(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.fifth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.fifth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingSixthElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.sixth(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.sixth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.sixth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingSeventhElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.seventh(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.seventh(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.seventh(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void changingEighthElementByAccessor() {
        ...
        // Changing by value.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = tuple.eighth(-1);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(tuple.size()));
        assertThat(secondTuple.first(), is(0));
        assertThat(secondTuple.second(), is(1));
        ...
        // Changing by supplier.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple = tuple.eighth(() -> -1);
        assertThat(thirdTuple, is(notNullValue()));
        assertThat(thirdTuple.size(), is(tuple.size()));
        assertThat(thirdTuple.first(), is(0));
        assertThat(thirdTuple.second(), is(1));
        ...
        // Changing by function.
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple = tuple.eighth(previous -> -1);
        assertThat(fourthTuple, is(notNullValue()));
        assertThat(fourthTuple.size(), is(tuple.size()));
        assertThat(fourthTuple.first(), is(0));
        assertThat(fourthTuple.second(), is(1));
    ...
    public void droppingFirstElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropFirst();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
    ...
    public void droppingSecondElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropSecond();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
    ...
    public void droppingThirdElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropThird();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
    ...
    public void droppingFourthElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropFourth();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
        assertThat(other.second(), is(tuple.second()));
    ...
    public void droppingFifthElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropFifth();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
        assertThat(other.second(), is(tuple.second()));
    ...
    public void droppingSixthElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropSixth();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
        assertThat(other.second(), is(tuple.second()));
    ...
    public void droppingSeventhElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropSeventh();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
        assertThat(other.second(), is(tuple.second()));
    ...
    public void droppingEighthElementByAccessor() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other = tuple.dropEighth();
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(7));
        assertThat(other.first(), is(tuple.first()));
        assertThat(other.second(), is(tuple.second()));
    ...
    public void streamingTuple() {
        ...
        assertThat(items, is(hasSize(8)));
        assertThat(items, is(contains(0, 1, 2, 3, 4, 5, 6, 7)));
    }
    ...
    public void checkingPredicateByIndex() {
        EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = EightTuple.of(0, 1, 2, 3, 4, 5, 6, 7);
        for (int i = 0; i < 8; i++) {
    ...
    public void extendingByValue() {
        EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = EightTuple.of(0, 1, 2, 3, 4, 5, 6, 7);
        NineTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = EightTuple.extendWith(-1).apply(tuple);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(9));
        ...
        assertThat(secondTuple.drop(8), is(tuple));
    }
    ...
    public void extendingByFunction() {
        EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = EightTuple.of(0, 1, 2, 3, 4, 5, 6, 7);
        NineTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = EightTuple.extendWith((EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> t) -> -1).apply(tuple);
        assertThat(secondTuple, is(notNullValue()));
        assertThat(secondTuple.size(), is(9));
        assertThat(secondTuple.first(), is(tuple.first()));
        assertThat(secondTuple.second(), is(tuple.second()));
    ...
    public void labelingTuple() {
        EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = EightTuple.of(0, 1, 2, 3, 4, 5, 6, 7);
        LabeledTuple<Integer> other = tuple.withLabels("e0", "e1", "e2", "e3", "e4", "e5", "e6", "e7");
        assertThat(other, is(notNullValue()));
        assertThat(other.size(), is(8));
        assertThat(other.labels(), is(contains("e0", "e1", "e2", "e3", "e4", "e5", "e6", "e7")));
    ...
    public void equality() {
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
        EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
