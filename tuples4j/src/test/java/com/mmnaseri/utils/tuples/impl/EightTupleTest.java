...
public class EightTupleTest {
  ...
  public void creatingTuple() {
    EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
  ...
  public void testToArray() {
    Tuple<Object> tuple = Tuple.of(0, 1, 2, 3, 4, 5, 6, 7);
  ...
  public void testResizeAsEmpty() {
    Tuple<Object> tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
  ...
  public void droppingFirstElementByAccessor() {
    EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> other =
        tuple.dropFirst();
    assertThat(other, is(notNullValue()));
    assertThat(other.size(), is(7));
  ...
  public void checkingPredicateByIndex() {
    EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        tuple = EightTuple.of(0, 1, 2, 3, 4, 5, 6, 7);
    for (int i = 0; i < 8; i++) {
  ...
  public void extendingByValue() {
    ...
    NineTuple<
            ...
            Integer,
            Integer>
        secondTuple = EightTuple.extendWith(-1).apply(tuple);
    assertThat(secondTuple, is(notNullValue()));
  ...
  public void equality() {
    EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        tuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
    EightTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        secondTuple = Tuple.eight(0, 1, 2, 3, 4, 5, 6, 7);
