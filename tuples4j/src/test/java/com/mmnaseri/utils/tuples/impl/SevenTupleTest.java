...
public class SevenTupleTest {
  ...
  public void creatingTuple() {
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        Tuple.seven(0, 1, 2, 3, 4, 5, 6);
  ...
  public void testToArray() {
    Tuple<Object> tuple = Tuple.of(0, 1, 2, 3, 4, 5, 6);
  ...
  public void testResizeAsEmpty() {
    Tuple<Object> tuple = Tuple.seven(0, 1, 2, 3, 4, 5, 6);
  ...
  public void changingFirstElementByAccessor() {
    ...
    // Changing by value.
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> secondTuple =
        tuple.first(-1);
    ...
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> thirdTuple =
        tuple.first(() -> -1);
    ...
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> fourthTuple =
  ...
  public void droppingFirstElementByAccessor() {
    SevenTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        Tuple.seven(0, 1, 2, 3, 4, 5, 6);
    SixTuple<Object, Integer, Integer, Integer, Integer, Integer, Integer> other =
        tuple.dropFirst();
    assertThat(other, is(notNullValue()));
    assertThat(other.size(), is(6));
  ...
  public void checkingPredicateByIndex() {
    SevenTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> tuple =
        SevenTuple.of(0, 1, 2, 3, 4, 5, 6);
    for (int i = 0; i < 7; i++) {
  ...
  public void extendingByValue() {
    ...
    EightTuple<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>
        secondTuple = SevenTuple.extendWith(-1).apply(tuple);
    assertThat(secondTuple, is(notNullValue()));
