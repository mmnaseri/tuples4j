...
public class LabeledTupleTest {
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp = "Expected 3 labels, but received 2")
  ...
  @Test(
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Provided set of labels contains duplicates: \\[a, a, b]")
  ...
  @Test(
      expectedExceptions = IllegalArgumentException.class,
      expectedExceptionsMessageRegExp = "Label a already exists on this tuple")
  ...
  @Test(
      ...
      expectedExceptionsMessageRegExp = "Index out of range: b")
